    ...
    <div class="body">
        <fs:form action="store" modelAttribute="khachhang" method="post">
            <div class="mb-3">
                ...
                <fs:input type="text" name="ma" path="ma" class="form-control" aria-describedby="emailHelp"
                          required=""/>
            ...
            <div class="mb-3">
                ...
                <fs:input type="text" name="diaChi" path="diaChi" class="form-control"/>

            </div>
            <div class="mb-3">
                <label for="" class="form-label">Thành Phố :</label>
                <fs:input type="text" name="thanhPho" path="thanhPho" class="form-control"
